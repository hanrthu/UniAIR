...
from models.encoders.LatentAdapter.transformer.attention import MultiHeadSelfAttention, FlashMultiHeadSelfAttention
...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, x, key_padding_mask=None, need_attn_weights=False):
        ...
        for block in self.blocks:
            ...
            #     use_reentrant=False
            #     )
            x, attn = block(x, key_padding_mask, need_attn_weights)
            if need_attn_weights:
